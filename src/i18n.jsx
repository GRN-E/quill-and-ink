...
export const STRINGS = {
  mn: {
    ...
    app_autosaving: 'Хадгалж байна…',
    app_autosaved: 'Хадгалсан',
    app_limit_docs_title: 'Үнэгүй багцын баримтын хязгаарт хүрлээ',
    app_limit_docs_body: 'Үнэгүй багцаар дээд тал нь {max} баримт хадгална. Илүү ихийг хадгалахын тулд Алтан багц руу шилжинэ үү.',
    app_locked_golden: 'Алтан багц',
    app_ad_title: 'Зар үзэж 1 нэмэлт ашиглалт нээх',
    app_ad_watch: 'Зар үзсэн (туршилт)',
    app_golden_only: 'Энэ боломж зөвхөн Алтан багцад. Үнийн хуудас руу очих уу?',
    pr_title: 'Энгийн, ойлгомжтой үнэ',
    pr_subtitle: 'Үнэгүй эхэл. Хэрэгтэй үедээ Алтан багц руу шилж.',
    pr_free_name: 'Үнэгүй',
    pr_free_price: '₮0',
    pr_free_period: 'үүрд',
    pr_golden_name: 'Алтан',
    pr_golden_price: '₮9,900',
    pr_golden_period: 'сар бүр',
    pr_golden_badge: 'Бүх боломж',
    pr_cta_free_current: 'Таны багц',
    pr_cta_free_start: 'Үнэгүй эхлэх',
    pr_cta_golden: 'Алтан багц авах',
    pr_f_docs: '{n} баримт хадгалах',
    pr_f_pages: 'Баримт тус бүр {n} хүртэл хуудас',
    pr_f_templates_basic: 'Үндсэн загвар (Хоосон, Захидал)',
    pr_f_templates_all: 'Бүх загвар',
    pr_f_png_ad: 'PNG экспорт (зар үзээд)',
    pr_f_png_free: 'PNG экспорт (зааваргүй)',
    pr_f_pdf: 'PDF экспорт',
    pr_f_header: 'Баримтын толгой',
    pr_f_nowm: 'Ус тэмдэггүй',
    pr_f_noads: 'Зар сурталчилгаагүй',
    up_title: 'Алтан багц руу шилжих',
    up_body: 'Төлбөрийн систем удахгүй нэмэгдэнэ. Одоогоор Алтан багцыг идэвхжүүлэх боломжгүй байна.',
    up_soon: 'Төлбөр (QPay / SocialPay) — удахгүй',
    up_back: '← Буцах',
    acc_title: 'Тохиргоо',
    acc_plan: 'Таны багц',
    acc_usage: 'Ашиглалт',
    acc_docs_used: 'Хадгалсан баримт',
    acc_ads_today: 'Өнөөдрийн зар-нээлт',
    acc_profile: 'Профайл',
    acc_email: 'И-мэйл',
    acc_member_since: 'Бүртгүүлсэн',
    acc_billing: 'Төлбөр',
    acc_billing_soon: 'Төлбөрийн систем удахгүй (QPay / SocialPay).',
    acc_upgrade_btn: 'Алтан багц авах',
    acc_open_app: '← Апп руу буцах',
    app_account: 'Тохиргоо',
    app_chars: 'тэмдэгт',
    app_words: 'үг',
  ...
  en: {
    ...
    app_autosaving: 'Saving…',
    app_autosaved: 'Saved',
    app_limit_docs_title: 'Free plan document limit reached',
    app_limit_docs_body: 'The Free plan saves up to {max} documents. Upgrade to Golden to save more.',
    app_locked_golden: 'Golden',
    app_ad_title: 'Watch an ad to unlock 1 extra use',
    app_ad_watch: 'Simulate ad watched',
    app_golden_only: 'This feature is Golden only. Go to the pricing page?',
    pr_title: 'Simple, clear pricing',
    pr_subtitle: 'Start free. Upgrade to Golden when you need more.',
    pr_free_name: 'Free',
    pr_free_price: '₮0',
    pr_free_period: 'forever',
    pr_golden_name: 'Golden',
    pr_golden_price: '₮9,900',
    pr_golden_period: 'per month',
    pr_golden_badge: 'Everything',
    pr_cta_free_current: 'Your plan',
    pr_cta_free_start: 'Start free',
    pr_cta_golden: 'Get Golden',
    pr_f_docs: 'Save {n} documents',
    pr_f_pages: 'Up to {n} pages per document',
    pr_f_templates_basic: 'Basic templates (Blank, Letter)',
    pr_f_templates_all: 'All templates',
    pr_f_png_ad: 'PNG export (after an ad)',
    pr_f_png_free: 'PNG export (no ads)',
    pr_f_pdf: 'PDF export',
    pr_f_header: 'Document header',
    pr_f_nowm: 'No watermark',
    pr_f_noads: 'No ads',
    up_title: 'Upgrade to Golden',
    up_body: 'Payment is coming soon. Golden cannot be activated yet.',
    up_soon: 'Payment (QPay / SocialPay) — coming soon',
    up_back: '← Back',
    acc_title: 'Settings',
    acc_plan: 'Your plan',
    acc_usage: 'Usage',
    acc_docs_used: 'Saved documents',
    acc_ads_today: "Today's ad-unlocks",
    acc_profile: 'Profile',
    acc_email: 'Email',
    acc_member_since: 'Member since',
    acc_billing: 'Billing',
    acc_billing_soon: 'Payment is coming soon (QPay / SocialPay).',
    acc_upgrade_btn: 'Get Golden',
    acc_open_app: '← Back to app',
    app_account: 'Settings',
    app_chars: 'chars',
    app_words: 'words',
